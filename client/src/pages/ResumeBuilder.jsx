import { ArrowLeftIcon, Briefcase, ChevronLeft, ChevronRight, DownloadIcon, EyeIcon, EyeOff, FileText, FolderIcon, GraduationCap, Share2, Share2Icon, Sparkles, User } from 'lucide-react'
...
const ResumeBuilder = () => {
  ...
  return (
    <div>
      <div >
        <Link to={'/app'} className='ml-20 inline-flex gap-2 items-center text-slate-500 hover:text-slate-700 transition-all' >
      ...
      <div className='max-w-7xl mx-auto px-4 pb-8'>
        <div className='grid lg:grid-cols-12 gap-8'>
          {/* left panel - form */}
          <div className='mt-11 relative lg:col-span-5 rounded-lg overflow-hidden'>
              ...
              <div className='flex justify-between items-center mb-6 border-b border-gray-300 py-1'>
                ...
                <div className='flex item-center'>
                  {activeSectionIndex !== 0 && (
                    <button onClick={()=> setActiveSectionIndex((prevIndex)=> Math.max(prevIndex-1, 0))} className='flex items-center gap-1 p3 rounded-lg text-sm font-medium text-gray-600 hover:bg-gray-50 transition-all' disabled={activeSectionIndex === 0}>
          ...
          <div className='lg:col-span-7 max-lg:mt-6'>
              <div className=' mb-3 flex items-center justify-end gap-2'>
                ...
                <button onClick={changeResumeVisibility} className='flex items-center p-2 px-4 gap-2 text-xs bg-gradient-to-br from-purple-100 to-purple-200 text-purple-600 rounded-lg ring-purple-300 rounded-1g hover:ring transition-colors'>
